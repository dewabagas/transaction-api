...
router.put('/:productid', middleware.verify, product.validateProduct_update, controller.editProduct);
router.patch('/:productid', middleware.verify, product.validateProduct_patch, controller.updateProductById);
